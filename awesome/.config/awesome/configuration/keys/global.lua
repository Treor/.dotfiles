...
-- Volume control
    ...
    awful.key({}, "Print",
        function() awful.spawn.with_shell("exec maim | xclip -selection clipboard -t image/png") end),
    awful.key({"Alt"}, "Print",
        function() awful.spawn.with_shell("exec maim -i $(xdotool getactivewindow) | xclip -selection clipboard -t image/png") end),
    awful.key({"Shift"}, "Print",
        function() awful.spawn.with_shell("exec maim -s | xclip -selection clipboard -t image/png") end),
    awful.key({ modkey }, "d",
