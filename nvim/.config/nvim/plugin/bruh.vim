...
let s:p.inactive.left =  [ [ s:black, s:black_bright, 'bold' ], [ s:black_bright, s:gray, 'bold' ] ]
let s:p.inactive.right = [ [ s:black, s:black_bright, 'bold' ], [ s:black_bright, s:gray, 'bold' ] ]
